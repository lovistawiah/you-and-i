        ...
        <Transition>
            <section className="w-screen">
                ...
                <section className='flex justify-between md:block mt-2 w-full'>
                    ...
                    <section className='text-center text-xl font-roboto font-medium p-1 w-full'>User Profile</section>
                </section>
                {/* profile pic */}
                ...
                {/* user information */}
                <section className="text-center font-roboto text-lg font-medium pt-4 w-fit m-auto">{personInfo?.username}
                </section>
                <section className="text-center font-roboto text-sm font-light text-gray-500 w-fit m-auto">
                    {personInfo?.bio}
                </section>
                ...
                <form className="w-full h-fit flex mt-[35px] flex-col items-center gap-4" onSubmit={handleUserInfo}>
                    ...
                    <button className={`w-[100px] h-[33px] px-3.5 py-[7px] font-roboto  bg-blue-500 rounded-[5px] border flex items-center justify-center text-white text-base font-normal hover:bg-blue-600 active:bg-blue-700 outline-none md:w-[250px] md:text-lg disabled:bg-red-500 disabled:cursor-not-allowed ${usernameInput == "" ? 'bg-gray-400 cursor-not-allowed hover:bg-gray-600' : ''}`}
